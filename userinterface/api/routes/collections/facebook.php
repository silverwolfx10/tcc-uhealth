...
return call_user_func(function(){
    ...
    $collection
        ...
        ->setPrefix('/v1/facebookCallback')
        // Must be a string in order to support lazy loading
        ->setHandler('\Api\Controllers\FacebookCallbackController')
        ->setLazy(true);
...
//    $collection->options('/{access_token}', 'optionsOne');
    ...
    $collection->get('/', 'get', 'login-facebook-allow');
    $collection->get('/{aacess}', 'get', 'login-facebook-authenticating-allow');
