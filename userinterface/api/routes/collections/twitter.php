...
return call_user_func(function(){
    ...
    $collection
        ...
        ->setPrefix('/v1/twitterCallback')
        // Must be a string in order to support lazy loading
        ->setHandler('\Api\Controllers\TwitterCallbackController')
        ->setLazy(true);
...
//    $collection->options('/{access_token}', 'optionsOne');
    ...
    $collection->get('/', 'get', 'login-twitter-allow');
    $collection->get('/{aacess}', 'get', 'login-twitter-authenticating-allow');
